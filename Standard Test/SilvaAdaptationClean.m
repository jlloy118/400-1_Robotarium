...
for idx = 1:length(platoon_sizes)
    ...
    save("supremerrorsilvanomods","supremum_reference_error");
    ...
    save("silvanomodsspacing","max_spacing_error")
    ...
    maxspacingerrortotalsilvanomods = max(max_spacing_error);
    maxsupremreferrortotalsilvanomods = max(supremum_reference_error);

    save(sprintf("supremum_error_platoon_size_%d_silva", N), 'maxsupremreferrortotalsilvanomods');
    save(sprintf("spacing_error_platoon_size_%d_silva", N), 'maxspacingerrortotalsilvanomods');
    hold off;
end
...
for idx = 1:length(platoon_sizes)
    ...
    % Plot the dot
    plot(N, maxsupremreferrortotalsilvanomods, 'ko', 'MarkerFaceColor', 'b');  % Black filled dot

    % Plot the vertical dotted line
    line([N N], [0 maxsupremreferrortotalsilvanomods], 'LineStyle', '--', 'Color', 'b');  % Vertical line
end
...
for idx = 1:length(platoon_sizes)
    ...
    % Plot the dot
    plot(N, maxspacingerrortotalsilvanomods, 'ko', 'MarkerFaceColor', 'k');  % Black filled dot

    % Plot the vertical dotted line
    line([N N], [0 maxspacingerrortotalsilvanomods], 'LineStyle', '--', 'Color', 'k');  % Vertical line
end
