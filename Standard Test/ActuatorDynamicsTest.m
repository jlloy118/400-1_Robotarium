...
save("silvactnomodssupremum","supremum_reference_error");
...
save("silvactnomodsspacing","max_spacing_error")
...
maxspacingerrortotalsilvactnomods = max(max_spacing_error);
maxsupremreferrortotalsilvactnomods = max(supremum_reference_error);

save(sprintf("supremum_error_platoon_size_%d_silvact", N), 'maxsupremreferrortotalsilvactnomods');
save(sprintf("spacing_error_platoon_size_%d_silvact", N), 'maxspacingerrortotalsilvactnomods');
hold off;
end
...
for idx = 1:length(platoon_sizes)
    ...
    % Plot the dot
    plot(N, maxsupremreferrortotalsilvactnomods, 'ko', 'MarkerFaceColor', 'b');  % Black filled dot
    
    % Plot the vertical dotted line
    line([N N], [0 maxsupremreferrortotalsilvactnomods], 'LineStyle', '--', 'Color', 'b');  % Vertical line
end
...
for idx = 1:length(platoon_sizes)
    ...
    % Plot the dot
    plot(N, maxspacingerrortotalsilvactnomods, 'ko', 'MarkerFaceColor', 'k');  % Black filled dot
    
    % Plot the vertical dotted line
    line([N N], [0 maxspacingerrortotalsilvactnomods], 'LineStyle', '--', 'Color', 'k');  % Vertical line
end
